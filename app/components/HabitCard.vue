    ...
    <div class="space-y-0.5 mb-4">
      ...
      >
        ...
        <button
          ...
          :disabled="props.togglingTaskIds?.includes(task.id)"
        >
          <UIcon v-if="props.togglingTaskIds?.includes(task.id)" name="i-lucide-loader-2" class="w-3 h-3 text-primary-500 animate-spin" />
          <UIcon v-else-if="task.completed" name="i-lucide-check" class="w-3 h-3" />
        </button>
